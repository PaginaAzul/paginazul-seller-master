...
export class SubCategoryManagementComponent implements OnInit {
  ...
  getViewData() {
    ...
    this.spinner.show();
    this.service.postApi('/api/v1/user/getProductSubCategoryList', apireq, 0).subscribe((success: any) => {
  ...
  addCuisine() {
    ...
    this.service.formdataApi("/api/v1/user/addProductSubCategory", formData).subscribe((data: any) => {
  ...
  editCuisine() {
    ...
    formData.append("subcategoryId", this.cuisineId)
    if (this.profileUrl.length > 0) {
      formData.append(`image`, this.profileUrl[0])
    }

    this.service.formdataApi("/api/v1/user/updateProductSubCategory", formData).subscribe((data: any) => {
      if (data.body.response_code == 200) {
        this.getViewData()
        $("#toggles").modal('hide')
        this.service.succ(data.body.response_message)
  ...
  search(data) {
    ...
    this.service.postApi('/api/v1/user/getProductSubCategoryList', apireq, 1).subscribe((success: any) => {
      if (success.response_code == 200) {
        this.spinner.hide();
        this.recordArray = success.Data.docs;
        this.limit = success.Data.limit;
  ...
  blockApi(status, id) {
    ...
    this.spinner.show();
    this.service.postApi('/api/v1/user/updateStatusProductSubCategory', apireq, 0).subscribe((success: any) => {
      if (success.response_code == 200) {
        this.spinner.hide()
        this.getViewData()
